...
项目简介:本项目是一个类似于大众点评等打卡类APP的点评类项目。实现了短信登陆、书店点评、优惠券秒杀、每日签到、好友关注、粉丝关注博主后，主动推送博主的相关博客等多个模块。
用户可以浏览首页的推荐内容，搜索附近的书店，查看书店的详情和评价以及发表探店博客，抢购书店发布的限时秒杀商品。

## 克隆完整项目
git clone https://github.com/HairMoke/book-store-review.git
## 前端环境部署
